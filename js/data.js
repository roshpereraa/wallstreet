...
export const DESKS = {
  memes: {
    id: 'memes', kind: 'memes', name: 'Meme Coins', desk: 'Meme Coin Desk', color: '#9cff57', accent: '#d4ffb0',
  ...
  stocks: {
    id: 'stocks', kind: 'stocks', name: 'Stock Exchange', desk: 'Stock Exchange Desk', color: '#f5d27a', accent: '#ffe7a8',
...
export const label = (s) => LABELS[s] || tickers.get(s) || (s.startsWith('cg:') ? s.slice(3).split('-')[0].toUpperCase() : s);
